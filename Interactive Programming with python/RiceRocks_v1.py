...
class Ship:
    ...
    def shoot(self):
        ...
        a_missile = Sprite(a_missile.pos, a_missile.vel, 0, 0, missile_image, missile_info, sound = missile_sound)
...
class Sprite:
    ...
    def collide(self, ship_obj):
        return dist(self.get_position(), ship_obj.get_position())< ship_obj.get_radius() + self.get_radius()
...
def group_collide(set_of_sprites, other_sprite):
    ...
    for a_sprite in set_of_sprites:
